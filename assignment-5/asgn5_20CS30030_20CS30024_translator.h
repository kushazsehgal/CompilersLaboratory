...
class SymbolTable {
    public:
        ...
        map<string, Symbol> symbols;    /*list of all symbols in this table, mapped by their names */ 
...
/******************************GLOBAL VARIABLES****************************************/
extern vector<Quad *> quadArray;  // Quad Array
extern SymbolType::typeEnum currentType;  // Current Type
extern Symbol *currentSymbol;  // Current Symbol
extern int tableCount, temporaryCount;  // Counts of number of tables and number of temps generated
extern SymbolTable *currentTable, *globalTable, *parentTable;  // Symbol Tables
